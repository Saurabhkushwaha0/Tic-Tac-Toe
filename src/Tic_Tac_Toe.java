...
//		---------------------------------------------------------y--------
	...
	private void initialize() {
		...
		btn1.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		btn2.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		btn3.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		xCount.setFont(new Font("Times New Roman", Font.BOLD, 16));
		...
		btn4.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		btn5.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		btn6.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		lblPlayerO.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		oCount.setFont(new Font("Times New Roman", Font.BOLD, 16));
		...
		btn7.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		btn8.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
		...
		btn9.setFont(new Font("Trebuchet MS", Font.BOLD, 68));
